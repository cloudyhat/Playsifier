    ...
    <div className="bg-[#1A0F1E] text-[#D6DDC3] font-['Segoe_UI',_sans-serif] min-h-screen overflow-x-hidden">
      ...
      <nav className="flex justify-between items-center px-10 py-6 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center space-x-8 text-sm font-semibold">
          <a href="mailto:shreyas4768@gmail.com" className="hover:text-white transition-colors">Contact</a>
          <button 
      ...
      <footer className="max-w-7xl mx-auto px-10 py-16 border-t border-[#8E947F]/20 flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="max-w-xs">
          ...
          <div className="flex gap-4 text-[#D6DDC3]">
            <a href="https://github.com/cloudyhat" target="_blank" rel="noreferrer" className="hover:text-white hover:-translate-y-1 transition-transform duration-300">
            ...
            <a href="https://www.linkedin.com/in/shreya-907819225/" className="hover:text-white hover:-translate-y-1 transition-transform duration-300">
               <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <a href="https://x.com/ItsShreyaOnly" className="hover:text-white hover:-translate-y-1 transition-transform duration-300">
        ...
        <div className="flex gap-24 text-[13px]">
          ...
          <div>
            ...
            <div className="space-y-3 text-[#AEB59C] flex flex-col items-start">
              <a href="mailto:shreyas4768@gmail.com" className="hover:text-white transition-colors">
                Contact
              </a>
            </div>
          </div>
